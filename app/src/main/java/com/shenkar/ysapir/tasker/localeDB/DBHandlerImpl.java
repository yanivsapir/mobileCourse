...
public class DBHandlerImpl implements DBHandler {
    ...
    public int addTask(Task task) {
        ...
        try {
            ...
            taskValues.put(TaskColumnNamesContainer.TaskEntry.COLUMN_TASK_TEAMNAME, task.getTeam());
            taskValues.put(TaskColumnNamesContainer.TaskEntry.COLUMN_TASK_ISACCEPTED, task.isAccepted() ? 1 : 0);
        ...
        try {
            ...
            Cursor cursor = db.query(TaskColumnNamesContainer.TaskEntry.TABLE_NAME,
                    new String[]{TaskColumnNamesContainer.TaskEntry.COLUMN_TASK_ID,
                            ...
                            TaskColumnNamesContainer.TaskEntry.COLUMN_TASK_TEAMNAME,
                            TaskColumnNamesContainer.TaskEntry.COLUMN_TASK_ISACCEPTED},
            ...
            if (cursor != null) {
                ...
                task.setTeam(cursor.getString(9));
                task.setIsAccepted(Integer.parseInt(cursor.getString(10)) == 1 ? true : false);
            }
            if (cursor != null) {
                cursor.close();
            }
