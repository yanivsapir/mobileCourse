        ...
        ParseUser.logInInBackground(username, password, new LogInCallback() {
            ...
            public void done(ParseUser user, ParseException e) {
                if (e == null) {
                    ...
                    Constants.isManager = Integer.parseInt(user.get("isManager").toString()) == 1 ? true : false;
                    Constants.teamName = user.get("team").toString();
                    Toast.makeText(LoginActivity.this, "Welcome back to Tasker", Toast.LENGTH_LONG).show();
